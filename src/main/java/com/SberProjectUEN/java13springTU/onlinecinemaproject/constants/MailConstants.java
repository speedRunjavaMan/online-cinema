package com.SberProjectUEN.java13springTU.onlinecinemaproject.constants;
...
public interface MailConstants {
    ...
    String MAIL_SUBJECT_FOR_REMEMBER_PASSWORD = "Восстановление пароля на сайте Онлайн кинотеатра";
}
