...
import static com.SberProjectUEN.java13springTU.onlinecinemaproject.constants.UserRolesConstants.*;
...
//                   )
              //Настройка http запросов - кому куда можно/нельзя
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(COMPOSERS_WHITE_LIST.toArray(String[]::new)).permitAll()
                        ...
                        .requestMatchers(COMPOSERS_PERMISSION_LIST.toArray(String[]::new)).hasAnyRole(ADMIN, LIBRARIAN)
